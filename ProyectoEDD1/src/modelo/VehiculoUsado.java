...
public class VehiculoUsado extends Vehiculo implements Serializable {
    ...
    public VehiculoUsado(Usuario dueno, String marca, String modelo, int ano, int kilometraje, double precio) {
        super(dueno, marca, modelo, ano, kilometraje, precio);
    }    

    public VehiculoUsado(Usuario dueno, TipoCosto tipoCosto, String marca, String modelo, int ano, int kilometraje, double precio, Motor motor, Transmision transmision, Ubicacion ubicacion, Historial historial, TipoTraccion traccion, TipoDireccion direccion, Color color, boolean climatizado, int numHilera, int numPuerta, String foto) {
        super(dueno, tipoCosto, marca, modelo, ano, kilometraje, precio, motor, transmision, ubicacion, historial, traccion, direccion, color, climatizado, numHilera, numPuerta, foto);
    }
